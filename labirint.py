...
wall_1 = GameSprite('negr.jpg',300,150,50,350) 
wall_2 = GameSprite('negr.jpg',150,300,150,50) 
wall_3 = GameSprite('negr.jpg',500,300,200,50) 
wall_4 = GameSprite('negr.jpg',0,150,150,50) 
wall_5 = GameSprite('negr.jpg',300,150,250,50) 
enemy = Enemy('negr.jpg',60,60,80,80,10,0) 
packman = Player('1000-7.jpg',180,380,50,50,0,0) 
final = GameSprite('papa.jpg',600,400,80,80) 
lose = GameSprite('fort.jpg', 0,0,700,500)
win = GameSprite('mama.jpg',0,0,700,500)
run = True 
while run: 
    for i in event.get(): 
        if i.type == QUIT: 
